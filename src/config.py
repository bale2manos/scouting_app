...
TEAM_NAME_DISPLAY = "EB FELIPE ANTON"   # texto visible
TEAM_SLUG = "eb_felipe_anton"           # para rutas (minúsculas + _)
...
NEXT_MATCH_DATE = "29/11/2024"  # Fecha del próximo partido (formato DD/MM/YYYY)
LEAGUE_POSITION = "9º"          # Posición en la liga
WINS_LOSSES = "3-5"           # Victorias-Derrotas
